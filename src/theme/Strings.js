export default {
  ...
  login_text: 'Sign In',
  login_text1: 'Sign In',
  login_text2: 'Enter email/mobile no. & password to continue',
  forgot_text1: 'Reset Your Password',
  forgot_text2: 'You need One Time Password to reset password',
  signup_text: 'Sign Up',
  signup_text1: 'Welcome to ShaKumbari Big Bazzar',
  ...
  nameErrorMessage: 'Please Enter your correct name',
  mobileErrorMessage: 'Please Enter correct mobile number',
